-- INSERTS: MUSICO
INSERT INTO musico (nome, apelido, email, senha, telefone, endereco, foto_perfil, biografia, tipo_musico) VALUES ('João Silva', 'JSilva', 'joao.silva@example.com', 'senhaSegura123', '(11) 91234-5678', 'Rua das Flores, 123 - São Paulo, SP', 'iVBORw0KGgoAAAANSUhEUgAAAAUA', 'Músico apaixonado por jazz e música instrumental. Atua há mais de 10 anos.', 'SOLO');
INSERT INTO musico (nome, apelido, email, senha, telefone, endereco, foto_perfil, biografia, tipo_musico) VALUES ('Maria Oliveira', 'MariOli', 'maria.oliveira@example.com', 'melodiaForte456', '(21) 99876-5432', 'Av. Atlântica, 987 - Rio de Janeiro, RJ', 'iVBORw0KGgoAAAANSUhEUgAAAAUB', 'Cantora e compositora com influências da MPB e bossa nova.', 'SOLO');
INSERT INTO musico (nome, apelido, email, senha, telefone, endereco, foto_perfil, biografia, tipo_musico) VALUES ('Lucas Andrade', 'LAndrade', 'lucas.andrade@example.com', 'bateriaTop789', '(31) 97777-2222', 'Rua dos Tambores, 56 - Belo Horizonte, MG', 'iVBORw0KGgoAAAANSUhEUgAAAAUC', 'Baterista profissional atuando em bandas de rock alternativo.', 'BANDA');
INSERT INTO musico (nome, apelido, email, senha, telefone, endereco, foto_perfil, biografia, tipo_musico) VALUES ('Ana Costa', 'AnaC', 'ana.costa@example.com', 'pianoMelody321', '(41) 98765-1122', 'Rua Harmonia, 75 - Curitiba, PR', 'iVBORw0KGgoAAAANSUhEUgAAAAUD', 'Pianista clássica com experiência em orquestras e eventos.', 'SOLO');
INSERT INTO musico (nome, apelido, email, senha, telefone, endereco, foto_perfil, biografia, tipo_musico) VALUES ('Pedro Rocha', 'PRocha', 'pedro.rocha@example.com', 'baixoGroove654', '(71) 98888-3344', 'Rua dos Ritmos, 222 - Salvador, BA', 'iVBORw0KGgoAAAANSUhEUgAAAAUE', 'Baixista apaixonado por groove, funk e reggae.', 'BANDA');
INSERT INTO musico (nome, apelido, email, senha, telefone, endereco, foto_perfil, biografia, tipo_musico) VALUES ('Carolina Mendes', 'CaroM', 'carolina.mendes@example.com', 'vozDoce123', '(51) 99666-7788', 'Av. Central, 45 - Porto Alegre, RS', 'iVBORw0KGgoAAAANSUhEUgAAAAUF', 'Cantora de pop e soul, com repertório internacional.', 'SOLO');
INSERT INTO musico (nome, apelido, email, senha, telefone, endereco, foto_perfil, biografia, tipo_musico) VALUES ('Diego Almeida', 'DAlmeida', 'diego.almeida@example.com', 'tecladoVivo852', '(61) 91122-3344', 'Quadra 303, Brasília, DF', 'iVBORw0KGgoAAAANSUhEUgAAAAUG', 'Tecladista versátil com experiência em estúdios e casamentos.', 'SOLO');

-- INSERTS: CONTRATANTE
INSERT INTO contratante (nome, senha, telefone, email, endereco, foto_perfil, biografia, nome_empresa, tipo_contratante) VALUES ('João Silva', 'SenhaSegura123!', '11987654321', 'joao.silva@example.com', 'Rua das Flores, 123 - São Paulo, SP', '', 'Produtor de eventos musicais há mais de 10 anos, especializado em shows e festivais.', 'Silva Produções Artísticas', 'ESTABELECIMENTO');
INSERT INTO contratante (nome, senha, telefone, email, endereco, foto_perfil, biografia, nome_empresa, tipo_contratante) VALUES ('Maria Oliveira', 'Maria@2025', '21999887766', 'maria.oliveira@example.com', 'Av. Atlântica, 500 - Rio de Janeiro, RJ', '', 'Apaixonada por música e eventos culturais, contratante independente de bandas locais.', '', 'PESSOA_FISICA');
INSERT INTO contratante (nome, senha, telefone, email, endereco, foto_perfil, biografia, nome_empresa, tipo_contratante) VALUES ('Lucas Andrade', 'Luk123!@#', '31988776655', 'lucas.andrade@beatsound.com', 'Rua Belo Horizonte, 742 - Belo Horizonte, MG', '', 'Gerente do BeatSound Pub, responsável por eventos de música ao vivo toda semana.', 'BeatSound Pub', 'ESTABELECIMENTO');
INSERT INTO contratante (nome, senha, telefone, email, endereco, foto_perfil, biografia, nome_empresa, tipo_contratante) VALUES ('Carla Mendes', 'Carla#2024', '41991234567', 'carla.mendes@gmail.com', 'Rua XV de Novembro, 145 - Curitiba, PR', '', 'Organizadora de eventos particulares e festas corporativas. Ama descobrir novos talentos musicais.', '', 'PESSOA_FISICA');
INSERT INTO contratante (nome, senha, telefone, email, endereco, foto_perfil, biografia, nome_empresa, tipo_contratante) VALUES ('Eduardo Lima', 'EduLima@2025', '11995554433', 'eduardo.lima@aurafest.com', 'Av. Paulista, 2000 - São Paulo, SP', '', 'CEO da AuraFest, empresa especializada em grandes eventos e festivais de música eletrônica.', 'AuraFest Produções', 'ESTABELECIMENTO');
